...
describe('PlaySessionsService', () => {
    ...
    describe('getPlaySessionsResults', () => {
      ...
      it('should return play session results by user', async () =>
      {
        ...
        const playSessionResults:[PlaySession[],number] = await service.getPlaySessionsResults(filters,zoomContext);
    ...
    describe('getPlaySessionsResults', () => {
      ...
      it('should return play sessions by user', async () =>
      {
        ...
        const playSessionsResult:PlaySession[] = await service.getPlaySessions(zoomContext);
    ...
    describe('getPlaySessionsReport', () => {
      ...
      it('should return play session report', async () =>
      {
        ...
        const playSessionReportResult:Report = await service.getPlaySessionReport(playSessionId);
    ...
    it('should create a play session',async () =>{
      ...
      const playSessionResult:PlaySession = await service.createPlaySession(playSessionDto);
