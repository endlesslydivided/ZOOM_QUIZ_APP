...
describe('ResultsService', () => {
    ...
    it('should create a result',async () =>{
      ...
      jest
        ...
        .mockImplementation((target) => {
          ...
          if(isQuiz){
            return {...original,findOneBy: jest.fn().mockResolvedValue(quizMock)}
          }
          else
          {
            return {...original,findOneBy: jest.fn().mockResolvedValue(answersMock)}
          }
    ...
    it('should throw an error if result answer is undefined',async () =>{
      ...
      jest
        ...
        await expect(service.createResult(resultDto)).rejects.toThrow(
          TypeError,
        );
