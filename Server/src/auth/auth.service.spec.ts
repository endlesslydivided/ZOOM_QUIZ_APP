...
describe('AuthService', () => {
    ...
    const tokenMock = '239rh0fuqufwh0rghosivd.a2uhqfewaugahvbiuyajhf.76u234ehofqewn8oh3f90he';
    ...
    describe('getDeeplink', () => {
      ...
      it('should return link', async () =>
      {
        ...
        expect(service.apiRequest).toBeCalledWith('POST', '/zoomapp/deeplink', tokenEntryMock.access_token, {
    ...
    describe('refreshToken', () => {
      ...
      it('should return token entry', async () =>
      {
        ...
        expect(service.tokenRequest).toBeCalledWith({refresh_token: tokenMock,grant_type: 'refresh_token',});
    ...
    describe('getToken', () => {
      ...
      it('should return token entry', async () =>
      {
        ...
        const tokenEntry = await service.getToken(codeDummy,verifierDummy,'S256');
      ...
      {
        await expect(
          service.getToken(codeDummy,null,'S256'),
        ).rejects.toThrow(InternalServerErrorException);     
      })
    ...
    describe('apiRequest', () => {
      ...
      it('should throw bad request exception', async () =>
      {
        ...
        await expect(service.apiRequest(method,endpoint,tokenMock)).rejects.toThrow(
          BadRequestException,
        );
      })  
    })
